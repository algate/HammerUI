<template>
    <view class="bg-black">
        <scroll-view :scroll-y="modalName==null" class="page" :class="modalName!=null?'show':''">
            <view class="hammer-box h-margin-top bg-white">
                <view class="title">
                    宫格列表
                </view>
                <view>
                    <button class="bg-color" @tap="showModal" data-target="gridModal">设置</button>
                </view>
            </view>
            ...
            <!-- <view class="cu-list grid" :class="['col-' + gridCol,gridBorder?'':'no-border']"> -->
                ...
                <view class="grid grid-col-4" style="text-align: center;">
                    <view class="bg-img grid-item" v-for="(item,index) in cuIconList" :key="index" style="padding-bottom:0;">
                        <view :class="['cuIcon-' + item.cuIcon,'text-' + item.color]" style="position:relative;font-size: 36px;">
                            <view class="hammer-badge" v-if="item.badge!=0">
                                <block v-if="item.badge!=1">{{item.badge>99?'99+':item.badge}}</block>
                            </view>
                        </view>
                        <text>{{item.name}}</text>
            ...
            <view class="hammer-box h-margin-top">
                <view class="title">
                    菜单列表
                </view>
                <view>
                    <button class="bg-color" @tap="showModal" data-target="menuModal">设置</button>
                </view>
            </view>
